 ...
 * @author Marv
 */
@WebServlet(name = "showInformation2", urlPatterns = {"/showInformation2"})
public class showInformation2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String gsonData = gson.toJson(dao.getAllPurchaseObjectByDate(s));
